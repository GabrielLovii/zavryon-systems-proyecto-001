...
export type Order = { id: string; supplierId: string; lines: OrderLine[]; expectedDate: string; notes: string; responsible: string; requester?: string; requestedAt?: string; status: OrderStatus; createdAt: string };
