...
import { config, initialExpiries, initialOrders, initialPayments, initialReceptions, initialSources, initialUsers, products, supplierProducts, suppliers, type AppConfig, type Expiry, type Order, type Payment, type Product, type Reception, type Source, type Supplier, type SupplierProduct, type User } from './mock-data';
...
export function useDemoState() {
  ...
  return { state, update, restoreDemo: () => setState(initialDemoState()) };
}
