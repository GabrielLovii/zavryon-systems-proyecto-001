...
export default function Home() {
  ...
  useEffect(() => { if (!today) return; document.querySelectorAll('header p').forEach((element) => { if (element.textContent?.startsWith('Fecha de referencia:')) element.textContent = `Fecha de referencia: ${formatDateEs(today, { dateStyle: undefined, weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}`; }); }, [today]);
